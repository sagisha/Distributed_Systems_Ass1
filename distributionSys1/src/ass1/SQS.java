...
public class SQS {
    ...
    public SQS(AWSCredentials credentials, String queueName) throws Exception {
        ...
        this.createSQS(credentials, queueName);
    }

    private void createSQS(AWSCredentials credentials, String queueName) throws Exception {
        ...
        try {
            // Create a queue
            System.out.println("Creating " + queueName + " SQS queue\n");
    ...
    public List<Message> receiveMsg() throws Exception {
        ...
        try {
            // Receive messages
            ReceiveMessageRequest receiveMessageRequest = new ReceiveMessageRequest().withQueueUrl(queueUrl).withMaxNumberOfMessages(1).withWaitTimeSeconds(20);
