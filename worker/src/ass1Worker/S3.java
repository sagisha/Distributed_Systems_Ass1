...
public class S3 {
    ...
    public S3(AWSCredentials credentials ,String bucketName)throws Exception {
        this.s3 = AmazonS3ClientBuilder.standard().withCredentials(new AWSStaticCredentialsProvider(credentials)).withRegion("us-east-1").build();
